...
export default function AnalyzePage() {
  ...
  const handleWhatsAppShare = () => {
    if (!result) return;
    const summary = `🛡️ *Kavach AI — Crop Insurance Claim Summary*
  
  👨‍🌾 Farmer: ${form.farmer_name}
  📍 Location: ${form.district}, ${form.state}
  🌾 Crop: ${form.crop}
  🌧️ Weather: ${result.weather_event_details}
  💰 Claim Amount: ₹${result.claim_amount_inr.toLocaleString("en-IN", { maximumFractionDigits: 0 })}
  
  ${result.weather_event_confirmed ? "✅ CLAIM VERIFIED — Submit your letter to the bank" : "❌ Not eligible based on weather data"}
  
  📋 Your claim letter is ready at kavach-ai.vercel.app
  
  _Generated by Kavach AI — Free crop insurance intelligence for Indian farmers_`;
