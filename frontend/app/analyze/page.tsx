...
export default function AnalyzePage() {
  ...
  const handleWhatsAppShare = () => {
    if (!result) return;
    const letter = showTranslated 
      ? result.claim_document_translated 
      ...
      <div style={{ padding: "60px" }}>
        ...
        <div style={{ background: "white", borderRadius: "16px", padding: "32px", marginBottom: "24px", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
            ...
            <div style={{ display: "flex", gap: "8px" }}>
                ...
                <button onClick={handleWhatsAppShare} style={{ padding: "8px 16px", borderRadius: "8px", border: "none", background: "#25D366", color: "white", fontWeight: 700, fontSize: "13px", cursor: "pointer" }}>
                  📱 WhatsApp
                </button>
            </div>
            </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
          ...
          <button onClick={handleWhatsAppShare} style={{ padding: "16px", borderRadius: "12px", border: "none", background: "#25D366", color: "white", fontSize: "16px", fontWeight: 700, cursor: "pointer" }}>
            📱 Share on WhatsApp
          </button>
